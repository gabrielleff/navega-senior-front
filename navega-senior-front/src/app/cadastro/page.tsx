...
import AbrirNavegador from '../assets/cadastro/cadastro1.png';
import AbrirSite from '../assets/cadastro/cadastro2.png';
import Cadastrar from '../assets/cadastro/cadastro3.png';
import Informações from '../assets/cadastro/cadastro4.png';
import Termos from '../assets/cadastro/cadastro5.png';
import Finalizar from '../assets/cadastro/cadastro5.png';
import Login from '../assets/cadastro/cadastro6.png';
import AbrirApp from '../assets/cadastro/phone1.png';
import AbrirAppSite from '../assets/cadastro/phone2.png';
import CriarConta from '../assets/cadastro/phone3.png';
import Infos from '../assets/cadastro/phone4.png';
...
const Cadastro: React.FC = () => {
  ...
  return (
    <div className="w-full h-full bg-white m-4">
      <Navbar />
